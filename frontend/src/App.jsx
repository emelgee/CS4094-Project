              ...
              <div>
                <div className="formGrid">
                  <label>
                    ...
                    >
                      ...
                      {Object.entries(defenderDB).map(([k, v]) => (
                ...
                {preview && (
                  <div className="stack mt8">
                    ...
                    <div className="statRow">
                      <span>HP</span>
                      <strong>{preview.hp}</strong>
                    </div>
                    <div className="statRow">
                      <span>Def / SpD</span>
                      <strong>
                        {preview.def} / {preview.spd}
                      </strong>
                    </div>
                    <div className="statRow">
                      <span>Moves</span>
  ...
  const bossList = [
    {
      key: "roxanne",
      name: "Roxanne",
      sub: "Gym 1 · Rustboro City · Rock",
      type: "rock",
    },
    {
      key: "brawly",
      name: "Brawly",
      sub: "Gym 2 · Dewford Town · Fighting",
      type: "fighting",
    },
    {
      key: "wattson",
      name: "Wattson",
      sub: "Gym 3 · Mauville City · Electric",
      type: "electric",
    },
    {
      key: "flannery",
      name: "Flannery",
      sub: "Gym 4 · Lavaridge Town · Fire",
      type: "fire",
    },
    {
      key: "norman",
      name: "Norman",
      sub: "Gym 5 · Petalburg City · Normal",
      type: "normal",
    },
    {
      key: "winona",
      name: "Winona",
      sub: "Gym 6 · Fortree City · Flying",
      type: "flying",
    },
  ];
  return (
    <section>
      <div className="page-header">
        <h1>Boss Data</h1>
        <p className="muted">
          Gym leaders, rivals, and Elite Four — preset data for Gen 3.
        </p>
      </div>
      <div className="twoCol">
        <div className="col">
          <div className="rowBetween mb8">
            ...
            >
              ...
              <option>Ruby / Sapphire</option>
              <option>FireRed / LeafGreen</option>
            </select>
          </div>
          <div className="list">
            {bossList.map((b) => (
              <div
                key={b.key}
                className={`listItem boss-list-item${
                  activeBoss === b.key ? " active" : ""
                }`}
                onClick={() => setActiveBoss(b.key)}
              >
                <div>
                  <strong>{b.name}</strong>
                  <div className="muted">{b.sub}</div>
                </div>
                <span className={`type-chip type-${b.type}`}>
                  {capitalize(b.type)}
                </span>
              </div>
            ))}
        ...
        <div className="col">
          <details open className="panel">
            ...
            <div className="boss-meta">
              <span className="type-chip type-rock">Rock</span>
              <span className="muted small">
                Rustboro City · Lv 14–15 range
              </span>
            </div>
            <div className="list mt8">
              {[
                  ...
                  <div className="rowBetween">
                    ...
                    <div>
                      ...
                      {p.types.map((t) => (
                        <span
                          key={t}
                          className={`type-chip type-${t.toLowerCase()}`}
                        >
                          {t}
                        </span>
                      ))}
